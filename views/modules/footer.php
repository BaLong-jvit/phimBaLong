<div class="container-lg">
	<div class="row">
		<div class="col-12 col-lg-3 footer-logo-film">
		...
		<div class="col-12 col-lg-6">
			<div class="row">
				...
				<h3 class="footer-link-head">Phim Mới ZZ</h3>
		...
		<div class="col-12 col-lg-3">
			<div class="footer-contact">
				<!-- <img src="styles/vtlai/movie/img/Uniad_Logo.png"> -->
				<span>Thông tin liên hệ:</span>
				<p>Email: contact@phimmoi.net<br><!--Phone: 0900.000.000--></p>
				<span>IP của bạn:</span><p id="client-ipaddress" data-ip="27.68.68.9">27.68.68.9</p>
			</div>
		</div>
	</div>
</div>