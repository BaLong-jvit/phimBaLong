...
?>
    <div class="about-us-content-edit">
			<div class="title-about-us-edit">
                <label for="" class="lb-tt-content">Tiêu Đề 1:</label>
                <input type="text" class="lb-tt-content" name="tt_about_us" value="<?php echo $arrayInfoPage['about-us']['tt'] ?>">
	        </div>
	        <div class="row">
