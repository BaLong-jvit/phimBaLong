...
// category
	...
	function get_count_bill(){
		$sql="SELECT MAX(id_don) FROM db_donhang";
		return $this->queryOneData($sql)['MAX(id_don)'];
	}
	function insert_bill($max_bill, $id_film,$seat,$date_order, $account_id){
		$sql="INSERT INTO db_donhang(id_don, id_film, seat, date_book, id_book, status) VALUES ($max_bill, $id_film, '$seat', '$date_order', $account_id, 1)";
		return $this->queryNoResult($sql);
	}
